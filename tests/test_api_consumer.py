...
@pytest.fixture
def deploy_api_contract(get_oracle, get_job_id, chainlink_fee, get_link_token):
    # Arrange / Act
...
def test_send_api_request_testnet(deploy_api_contract, get_link_token, chainlink_fee):
    # Arrange
